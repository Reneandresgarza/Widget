...
[Quantity] [int] NOT NULL CONSTRAINT [DF__WidgetPur__Quant__2D27B809] DEFAULT ((1)),
[InvoiceNumber] [nvarchar] (20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Date] [datetime] NOT NULL CONSTRAINT [DF__WidgetPurc__Date__2E1BDC42] DEFAULT (getdate())
) ON [PRIMARY]
GO
